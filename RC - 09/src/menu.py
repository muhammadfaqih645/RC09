...
class MainMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text("Setting", 50, self.mid_w, self.mid_h + 100)
            self.game.draw_text("Exit", 50, self.mid_w, self.mid_h + 150)
...
class CreditsMenu(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text('mixkit', 20, self.mid_w , self.game.DISPLAY_H / 5 + 240)
